...
public class MainActivity extends AppCompatActivity implements LifecycleOwner {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        detectImagebtn = findViewById(R.id.detect_image_btn);
    ...
    private void setLabelerFromLocalModel() {
        localModel = new FirebaseAutoMLLocalModel.Builder()
                .setAssetFilePath("asl/manifest.json")
                .build();
        try {
...
//                startActivity(intent);
    ...
    private void fromRemoteModel() {
        ...
        remoteModel = new FirebaseAutoMLRemoteModel.Builder("asl_2020512164938").build();
